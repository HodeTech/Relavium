...
21 of 48 items closed** — `W0` (PR #82, 2026-08-11), `W1`, the eight P0 blockers plus `CR-92`, merged
...
terminal. No new product surface — only the invariants an existing surface already claims.
