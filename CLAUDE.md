...
feature-complete (published v0.1.1)**. **Phase 2.5 (CLI Consolidation) is ✅ complete** (milestone **M2.5-4**,
PR #69, 2026-07-08; history follows): its spine's secure
...
✅ **Done (2.5-close-out, PR #69, 2026-07-08)** — **reaching milestone M2.5-4, so Phase 2.5 is complete** — landed with the doable-now
