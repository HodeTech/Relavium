...
- The Phase-1 **`CostTracker`** + model-pricing model (Relavium's own pricing table,
  micro-cents) reused for metering ([database-schema.md](../../reference/shared-core/database-schema.md)).
