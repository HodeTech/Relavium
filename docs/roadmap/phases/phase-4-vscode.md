...
`relavium.exportChatSession` (session → `.relavium.yaml` scaffold, [ADR-0026](../../decisions/0026-session-export-to-workflow.md)) plus lightweight session persistence in extension state.

**Acceptance:** a chat session exports to a reviewable workflow and persists across a window reload.
