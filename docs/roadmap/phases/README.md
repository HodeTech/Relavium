...
| 2.6 | [phase-2.6-conversational-authoring.md](phase-2.6-conversational-authoring.md) | Phase 1 | Conversational authoring — a shared `@relavium/authoring` package, a chat that authors standards-valid `.relavium.yaml`, mid-session model reseat, and competitor-parity polish. |
