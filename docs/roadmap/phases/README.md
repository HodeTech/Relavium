...
| 2.5.5 | [phase-2.5.5-hardening-and-remediation.md](phase-2.5.5-hardening-and-remediation.md) | Phase 1 | Hardening and remediation interstitial — the verified findings of the 2026-07-19 full-project review that are not a natural fit for an open 2.6 workstream: engine/LLM/persistence hardening, the CLI operator-safety net, terminal safety, docs accuracy, and CI/test-infrastructure. Runs concurrently with Phase 2.6, remediating the pre-2.6 codebase; not a blocker of it. |
