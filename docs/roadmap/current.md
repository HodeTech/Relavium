...
2. ✅ **Reserve numbers** — **done**, recorded here: migrations end at `0012` and ADRs at `0072` (verified),
   so `0013` is **UNUSED** (D8 ruled against the approval-preview scrub; the number is retired, not re-assigned, so nothing below shifts) · `0014` = 2.5.5.C's enum CHECKs (#101) · `0015` = 2.6.H ·
