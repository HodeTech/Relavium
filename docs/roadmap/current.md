...
flowchart TD
    ...
    P265["Phase 2.6.5 — Core reliability<br/>48 CR items · 8 P0 blockers behind ADR-0078–0084<br/>W0+W1+W2 merged · W3 merged with a live blocker (25 of 48)<br/>absorbs the hostile-MCP class"]
...
> **Live status — 25 of 48 closed. `W0`–`W2` merged clean; `W3` merged 2026-08-30 (PR #86) with one reproduced BLOCKER and nine verified findings open — see the `W3` residuals in [deferred-tasks.md](deferred-tasks.md). `W4` does not start until that blocker is closed.**
>
